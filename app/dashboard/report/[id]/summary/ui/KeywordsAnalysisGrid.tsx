...
export function KeywordsAnalysisGrid({ seoReport }: KeywordsAnalysisGridProps) {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 min-w-0">
      {/* Content Keywords */}
      <Card className="border bg-linear-to-br from-card to-card/95 min-w-0 w-full">
        <CardHeader className="pb-4 sm:pb-6">
          <div className="flex items-start sm:items-center gap-3">
            <div className="p-2 sm:p-3 rounded-full bg-linear-to-br from-blue-100 to-cyan-100 dark:from-blue-900/50 dark:to-cyan-900/50 flex-shrink-0">
      ...
      <Card className="border bg-linear-to-br from-card to-card/95 min-w-0 w-full">
        <CardHeader className="pb-4 sm:pb-6">
          <div className="flex items-start sm:items-center gap-3">
            <div className="p-2 sm:p-3 rounded-full bg-linear-to-br from-orange-100 to-amber-100 dark:from-orange-900/50 dark:to-amber-900/50 flex-shrink-0">
