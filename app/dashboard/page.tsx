      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="space-y-8">
          ...
          <Card className="relative overflow-hidden border-0 shadow-2xl bg-linear-to-br from-blue-50/80 via-purple-50/80 to-pink-50/80 dark:from-blue-950/50 dark:via-purple-950/50 dark:to-pink-950/50 backdrop-blur-sm">
            ...
            <div className="absolute top-0 right-0 w-40 h-40 bg-linear-to-br from-blue-400/20 via-purple-400/20 to-pink-400/20 rounded-full -translate-y-20 translate-x-[25px]" />
            <div className="absolute bottom-0 left-0 w-32 h-32 bg-linear-to-tr from-purple-400/15 to-blue-400/15 rounded-full translate-y-16 -translate-x-16" />
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="flex flex-col md:flex-row gap-4">
                  <div className="flex-1 relative">
                    <div className="absolute left-4 top-1/2 transform -translate-y-1/2 ronded-md bg-blue-100 dark:bg-blue-900/30">
                  ...
                  <div className="group">
                    <Button
                      type="submit"
                      size="lg"
                      className="h-14 px-16 md:px-8 bg-linear-to-r from-blue-600 via-purple-600 to-pink-600 hover:from-blue-700 hover:via-purple-700 hover:to-pink-700 border-0 shadow-lg hover:shadow-xl hover:shadow-purple-500/25 transition-all duration-300 font-semibold w-full md:w-auto"
