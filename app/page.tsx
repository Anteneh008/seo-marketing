...
export default function Home() {
  return (
    <div className="min-h-screen bg-linear-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-slate-950 dark:via-blue-950 dark:to-purple-950">
      {/* Hero section */}
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 bg-linear-to-r from-blue-500/10 via-purple-500/10 to-pink-500/10" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top, rgba(120, 119, 198, 0.3))]" />
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-32 lg:px-8">
          <div className="text-center">
            <Badge className="mb-4 bg-linear-to-r from-blue-500/20 to-purple-500/20 text-blue-700 dark:text-blue-300 border-blue-500/30 hover:from-blue-500/30 hover:to-purple-500/30">
              <Sparkles className="w-3 h-3 mr-1 text-yellow-500" />
              Powered by Bright Data & OpenAI
            </Badge>

            <h1 className="text-4xl font-bold tracking-tight sm:text-6xl lg:text-7xl">
              <span className="bg-linear-to-r from-slate-900 via-blue-900 to-slate-900 dark:from-white bg-clip-text text-transparent">
                Generate Beautiful
              </span>
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Unauthenticated>
                <SignInButton mode="modal" forceRedirectUrl="/dashboard">
                  <Button
                    size="lg"
                    className="text-base px-8 py-6 bg-linear-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 shadow-lg hover:shadow-xl hover:shadow-blue-500/25 transition-all duration-300 group border-0"
                  >
      ...
      <section className="py-20 sm:py-32">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
            {/* Starter Plan Card */}
            <Card className="relative overflow-hidden border-2 border-blue-200 dark:border-blue-800 hover:border-blue-400 dark:hover:border-blue-600 transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/10 group bg-linear-to-br from-blue-50/50 dark:from-blue-950/50 dark:to-cyan-950/50">
              ...
              <CardHeader className="relative">
                ...
                <CardDescription className="text-base">
                  ...
                  Data&apos;s advanced SERP Preplexity Scraper technology
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="relative overflow-hidden border-2 border-purple-300 dark:border-purple-700 hover:border-purple-500 dark:hover:border-purple-500 transition-all duration-300 hover:shadow-2xl hover:shadow-purple-500/20 group bg-linear-to-br from-purple-50/80 via-pink-50/80 to-orange-50/80 dark:from-purple-950/50 dark:via-pink-950/80 dark:to-orange-950/50">
              ...
              <CardHeader className="relative">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <Badge className="bg-linear-to-r from-purple-100 to-pink-100 text-purple-700 hover:from-purple-200 hover:to-pink-200 dark:from-purple-900 dark:to-pink-900 dark:text-purple-300 border-0">
                    Pro
                  </Badge>
                </div>
              ...
              <CardContent>
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-2 text-sm">
                    <CheckCircle className="w-4 h-4 text-green-600" />
                    <span>AI-powere chat interface</span>
                  </div>
                  <div className="flex items-center gap-2 text-sm">
                    <CheckCircle className="w-4 h-4 text-green-600" />
      ...
      {/* Pricing Section */}
      <section className="py-20 sm:py-32 bg-linear-to-r from-emerald-50/50 via-blue-50/50 to-purple-50/50 dark:from-emerald-950/50 dark:via-blue-50 dark:to-purple-950/50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl mb-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <Card className="border-2 border-purple-300 dark:border-purple-700 hover:border-purple-500 hover:shadow-xl hover:shadow-purple-500/20 transition-all duration-300 relative bg-linear-to-br from-purple-50/80 via-pink-50/80 to-rose-50/80 dark:from-purple-950/80 dark:via-pink-950/80 dark:to-rose-950/80">
              <Badge className="absolute -top-3 left-1/2 -translate-x-1/2 bg-linear-to-r from-purple-600 to-pink-600 text-white border-2">
                Most Popular
              </Badge>
          ...
          <div className="mt-16 text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800">
              ...
              <span className="text-sm text-green-700 dark:text-green-300 font-medium">
                Enterprise-grade security security & 99.9% uptime guaranteed
              </span>
            </div>
          </div>
        </div>
