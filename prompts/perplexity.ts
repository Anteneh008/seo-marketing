export function buildPerplexityPrompt(target: string): string {
  return `
    ...
    TASK: Conduct a thorough web search and analysis of the traget entity, providing structured data for SEO research purposes.
    ...
    - Key metrics and statistics (follower counts, years of experiences, etc.)
    ...
    7. **EVIDENCE-BASED**: Include specific facts, numbers and claims with source attribution. Be comprehensive and factual as possible.
